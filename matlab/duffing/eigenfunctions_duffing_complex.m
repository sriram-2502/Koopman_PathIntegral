...
% using real and imag as vector
%V_lyap = (phi1_real.*phi1_imag)*P(1,1) + (phi1_real.*phi1_imag)*P(2,2);
% V_lyap_matlab = (phi1_real_matlab.*phi1_imag_matlab)*P(1,1) +...
%                     (phi1_real_matlab.*phi1_imag_matlab)*P(2,2);
